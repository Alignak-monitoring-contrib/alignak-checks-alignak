...
# --------------------------------------------------------------------------------
# This script is building packages for Alignak checks pack thanks to the fpm
...
pkg_name="${python_prefix}-alignak-checks-alignak"
pkg_description="Alignak checks pack - alignak"
